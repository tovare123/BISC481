...
## Data preparation
Sequence_Shape_Rsquared <- c(0.8646,0.8628,0.8549)
Sequence_Rsquared <- c(0.7855,0.7754,0.7785)


## Ploting
ggplot() +
  geom_point(aes(x = Sequence_Rsquared, y = Sequence_Shape_Rsquared), color = "red", size=1) +
